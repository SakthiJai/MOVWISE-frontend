...
Swal.fire({
  title: 'Success',
  text: preview ? 'PDF opened successfully!' : 'PDF downloaded successfully!',
  icon: 'success'
}).then((result) => {
  if (result.isConfirmed && window.innerWidth <= 768) {
    window.location.href = "/components/comparequotes";
  }
});
    } catch (error) {
