...
export default function Ouotesdetails() {
  ...
  <div className="flex items-center justify-between bg-red-50 mx-2 mt-2 rounded-2xl px-8 py-5">
    <div className="flex items-center gap-5">
      <Image  alt="MyHomeMove" className="w-24 h-14 object-contain" />
    ...
    <li className="flex justify-between gap-20 text-gray-400">
      ...
      <span className="text-gray-700 font-bold">£20,000.00</span>
            ...
            <div className="border border-gray-200 rounded-2xl overflow-hidden bg-white">
              ...
              {/* Body */}
              <div className="p-6">
               <div className="flex items-start justify-start gap-105">
                  {/* Reviews + Features */}
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 text-sm mt-1">
                      <span className="font-bold">3.2 out of 5</span> (356
                      reviews)
                    </p>
                     <p className="text-xs text-gray-1500 mt-1">Reviews on the web</p>
                  <div className="flex items-center gap-2 text-xs mt-1">
        <a href="#" className="text-gray-800 underline">
          TrustPilot
        </a>
        <p className="text-gray-500">• 4.7/5 • 9,308 reviews</p>
      </div>
       </div>
                     <ul className="text-xs text-gray-700 space-y-2">
                        <li>• Instruct us online in under two minutes</li>
                        <li>• No move, no legal fee GUARANTEED</li>
                        <li>• Track the progress of your case through eWay</li>
                        </ul>
                    </div>
      ...
      Instruct
                ...
                <div className="flex justify-between mt-8 border-t border-gray-200 pt-6">
                  <p className="text-xs  text-gray-600 max-w-2xl">
                    PM Property Lawyers is an award winning specialist property
                    Solicitors in Sheffield, accredited by the Conveyancing
                    Quality Scheme with clients both locally and nationwide. We
                    aim to provide our clients with a first class hassle free
                    service at a very reasonable cost. Our conveyancers
                    understand the pressures of buying and selling properties
                    and will guide you through the process in a professional and
                    helpful manner. A detailed quotation will be sent shortly.
                    <br />
                    <br />
                  ...
                  <div className="text-xs text-gray-700">
                    <h4 className="font-semibold mb-3">Price Breakdown:</h4>
                    <ul className="space-y-3 text-gray-400 pr-10 text-xs">
                        <li className="flex justify-between pr-1 gap-x-16 ">
                        <span>Sale fees</span>
                        <span className="font-bold text-gray-700">£908.40</span>
                        </li>
                        <li className="flex justify-between pr-1 gap-x-18">
                        <span>Sale disbursements</span>
                        <span className="font-bold text-gray-700">£14.00</span>
                        </li>
                    ...
                    <li className="flex justify-between pr-1 border-t border-gray-300 pt-2 font-medium text-gray-400">
                    <span>Total</span>
                    <span className="text-green-700 font-bold">£3,079.60</span>
                    </li>

                        <li className="flex justify-between pr-1 text-gray-400">
                        <span>Stamp Duty</span>
                        <span className=" font-bold text-gray-700">£20,000.00</span>
                        </li>
                    </ul>
                    </div>
