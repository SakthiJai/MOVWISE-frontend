...
// import AddressFields from '../[type]/AddressFields';
...
//                       </div>
//                       <p
//                         className={`text-[12px] mt-1 min-h-[16px] transition-all duration-200 ${errors.sales_price ? "text-red-500 opacity-100" : "opacity-0"
//                           }`}
//                       >
...
//                       <p
//                         className={`text-[12px] mt-1 min-h-[16px] transition-all duration-200 ${errors.no_of_bedrooms ? "text-red-500 opacity-100" : "opacity-0"
//                           }`}>
...
//                       <p
//                         className={`text-[12px] mt-1 min-h-[16px] transition-all duration-200 ${errors.leasehold_or_free ? "text-red-500 opacity-100" : "opacity-0"
//                           }`}>
...
//                     <p
//                       className={`text-[12px] mt-1 min-h-[16px] transition-all duration-200 ${errors.property_type ? "text-red-500 opacity-100" : "opacity-0"
//                         }`}>
...
//                       </select>
//                       <p
//                         className={`text-[12px] mt-1 min-h-[16px] transition-all duration-200 ${errors.shared_ownership ? "text-red-500 opacity-100" : "opacity-0"
//                           }`}>
...
//                             }))
//                           }
//                           className={`h-[44px] rounded-xl border-2 text-base font-semibold transition-all duration-200 flex items-center justify-center relative shadow-sm ${formData.existing_mortgage === 1
//                             ? "border-[#1E5C3B] bg-[#1E5C3B] text-white"
//                             : "border-gray-300 bg-white text-gray-700 hover:bg-gray-50"
//                             }`}
//                         >
...
//                             }))
//                           }
//                           className={`h-[44px] rounded-xl border-2 text-base font-semibold transition-all duration-200 flex items-center justify-center relative shadow-sm ${formData.existing_mortgage === 0
//                             ? "border-[#1E5C3B] bg-[#1E5C3B] text-white"
//                             : "border-gray-300 bg-white text-gray-700 hover:bg-gray-50"
//                             }`}
//                         >
